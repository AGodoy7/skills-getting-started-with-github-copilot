...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps, learn technique, and compete in meets",
        "schedule": "Mondays and Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["emma@mergington.edu", "ava@mergington.edu"]
    },
    "Drama Club": {
        "description": "Perform plays, practice acting, and explore theater arts",
    ...
    "Science Club": {
        "description": "Explore experiments, research projects, and scientific discovery",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
